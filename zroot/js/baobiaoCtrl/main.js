var sqllite = {
	...
	dataOfInit:{
		SH:{
			...
			tableName:"SHInfo",
			userName:"wangpeng",
			baseUrl:"http://10.221.235.17:8080/INAS",
			huanCun:[
				"srpt-cfg-reportInfo",
				"srpt-cfg-colorQueryField",
				"eaebm-bsParCfg",
				"reportHeader",
				"srpt-cfg-menuQueryself",
			],
			menuUrl:"http://10.221.235.17:8080/INAS/sml/invoke/srptMngResource/asyncFindByCreator/asyncFindByCreator",
			reportInfoUrl:"http://10.221.235.17:8080/INAS/sml/query/srpt-cfg-reportInfo",
		},
		LN:{
			name:"辽宁报表管理",
			sqlDate:{},
			tableName:"LNInfo",
			userName:"admin",
			baseUrl:"http://10.204.210.21:8080/INAS",
			huanCun:[
				"srpt-cfg-reportInfo",
				"srpt-cfg-colorQueryField",
				"eaebm-bsParCfg",
			...
			menuUrl:"http://10.204.210.21:8080/INAS/sml/invoke/srptMngResource/asyncFindByCreator/asyncFindByCreator",
			reportInfoUrl:"http://10.204.210.21:8080/INAS/sml/query/srpt-cfg-reportInfo",
		},
	},
	init:function () {
		sqllite.dbId = $("#rootUrl").val()+"/.db";
		var head = {
			id:"string",
			fileId:"string",
			nodeId:"string",
		...
		for(var i in sqllite.dataOfInit){
			sqllite.dataOfInit[i].sqlDate={};
			var tableName = sqllite.dataOfInit[i].tableName;
